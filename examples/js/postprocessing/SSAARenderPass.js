/**
 * Generated from 'examples/jsm/postprocessing/SSAARenderPass.js'
 */

(function (global, factory) {
typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('..\..\..\js\postprocessing\EffectComposer.js'), require('..\..\shaders\CopyShader.js')) :
typeof define === 'function' && define.amd ? define(['exports', 'three', '..\..\..\js\postprocessing\EffectComposer.js', '..\..\shaders\CopyShader.js'], factory) :
...
var SSAARenderPass = function ( scene, camera, clearColor, clearAlpha ) {
	...
	if ( CopyShader_js.CopyShader === undefined ) console.error( "SSAARenderPass relies on CopyShader" );
	...
	this.fsQuad = new Pass_js.Pass.FullScreenQuad( this.copyMaterial );

};

SSAARenderPass.prototype = Object.assign( Object.create( Pass_js.Pass.prototype ), {
