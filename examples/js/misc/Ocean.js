/**
 * Generated from 'examples/jsm/misc/Ocean.js'
 */

(function (global, factory) {
typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('..\..\shaders\OceanShaders.js')) :
typeof define === 'function' && define.amd ? define(['exports', 'three', '..\..\shaders\OceanShaders.js'], factory) :
(global = global || self, factory(global.THREE = global.THREE || {}, global.THREE, global.THREE));
}(this, function (exports, THREE, OceanShaders_js) { 'use strict';
...
var Ocean = function ( renderer, camera, scene, options ) {
	...
	var fullscreeenVertexShader = OceanShaders_js.OceanShaders[ "ocean_sim_vertex" ];

	// 1 - Horizontal wave vertices used for FFT
	var oceanHorizontalShader = OceanShaders_js.OceanShaders[ "ocean_subtransform" ];
	...
	var oceanVerticalShader = OceanShaders_js.OceanShaders[ "ocean_subtransform" ];
	...
	var initialSpectrumShader = OceanShaders_js.OceanShaders[ "ocean_initial_spectrum" ];
	...
	var phaseShader = OceanShaders_js.OceanShaders[ "ocean_phase" ];
	...
	var spectrumShader = OceanShaders_js.OceanShaders[ "ocean_spectrum" ];
	...
	var normalShader = OceanShaders_js.OceanShaders[ "ocean_normals" ];
	...
	var oceanShader = OceanShaders_js.OceanShaders[ "ocean_main" ];
