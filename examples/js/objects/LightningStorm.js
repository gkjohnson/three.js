/**
 * Generated from 'examples/jsm/objects/LightningStorm.js'
 */

(function (global, factory) {
typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('..\..\geometries\LightningStrike.js')) :
typeof define === 'function' && define.amd ? define(['exports', 'three', '..\..\geometries\LightningStrike.js'], factory) :
(global = global || self, factory(global.THREE = global.THREE || {}, global.THREE, global.THREE));
}(this, function (exports, THREE, LightningStrike_js) { 'use strict';
...
var LightningStorm = function ( stormParams ) {
	...
	this.lightningParameters = LightningStrike_js.LightningStrike.copyParameters( stormParams.lightningParameters, stormParams.lightningParameters );
	...
	for ( var i = 0; i < this.stormParams.maxLightnings; i ++ ) {
		...
		var lightning = new LightningStrike_js.LightningStrike( LightningStrike_js.LightningStrike.copyParameters( {}, this.lightningParameters ) );
...
LightningStorm.prototype.update = function ( time ) {
	...
	if ( time >= this.nextLightningTime ) {
		...
		if ( lightningMesh ) {
			...
			var lightningParams1 = LightningStrike_js.LightningStrike.copyParameters( lightningMesh.geometry.rayParameters, this.lightningParameters );
	...
	while ( i < il ) {
		...
		if ( prevState === LightningStrike_js.LightningStrike.RAY_PROPAGATING && lightning.state > prevState ) {
		...
		if ( lightning.state === LightningStrike_js.LightningStrike.RAY_EXTINGUISHED ) {
...
LightningStorm.prototype.copy = function ( source ) {
	...
	this.lightningParameters = LightningStrike_js.LightningStrike.copyParameters( {}, source.lightningParameters );
...
LightningStrike_js.LightningStrike.prototype.clone = function () {
