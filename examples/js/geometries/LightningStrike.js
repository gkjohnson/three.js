/**
 * Generated from 'examples/jsm/geometries/LightningStrike.js'
 */

(function (global, factory) {
typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('..\..\math\SimplexNoise.js')) :
typeof define === 'function' && define.amd ? define(['exports', 'three', '..\..\math\SimplexNoise.js'], factory) :
(global = global || self, factory(global.THREE = global.THREE || {}, global.THREE, global.THREE));
}(this, function (exports, THREE, SimplexNoise_js) { 'use strict';
...
LightningStrike.prototype.init = function ( rayParameters ) {
	...
	this.simplexX = new SimplexNoise_js.SimplexNoise( this.seedGenerator );
	this.simplexY = new SimplexNoise_js.SimplexNoise( this.seedGenerator );
	this.simplexZ = new SimplexNoise_js.SimplexNoise( this.seedGenerator );
