...
typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('..\obj2\worker\parallel\OBJLoader2Parser.js'), require('..\obj2\shared\MeshReceiver.js'), require('..\obj2\shared\MaterialHandler.js')) :
typeof define === 'function' && define.amd ? define(['exports', 'three', '..\obj2\worker\parallel\OBJLoader2Parser.js', '..\obj2\shared\MeshReceiver.js', '..\obj2\shared\MaterialHandler.js'], factory) :
...
const OBJLoader2 = function ( manager ) {
	...
	this.materialHandler = new MaterialHandler_js.MaterialHandler();
...
OBJLoader2.prototype = {
	...
	parse: function ( content ) {
		...
		let parser = new OBJLoader2Parser_js.OBJLoader2Parser();
