/**
 * Generated from 'examples/jsm/loaders/NRRDLoader.js'
 */

(function (global, factory) {
typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('..\..\libs\gunzip.module.min.js'), require('..\..\misc\Volume.js')) :
typeof define === 'function' && define.amd ? define(['exports', 'three', '..\..\libs\gunzip.module.min.js', '..\..\misc\Volume.js'], factory) :
(global = global || self, factory(global.THREE = global.THREE || {}, global.THREE, global.window, global.THREE));
...
NRRDLoader.prototype = {
	...
	parse: function ( data ) {
		...
		if ( headerObject.encoding === 'gzip' || headerObject.encoding === 'gz' ) {
			...
			var inflate = new gunzip_module_min_js.Zlib.Gunzip( new Uint8Array( _data ) ); // eslint-disable-line no-undef
