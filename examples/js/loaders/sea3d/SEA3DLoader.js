/**
 * Generated from 'examples/jsm/loaders/sea3d/SEA3DLoader.js'
 */

(function (global, factory) {
typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('..\SEA3DSDK.js')) :
typeof define === 'function' && define.amd ? define(['exports', 'three', '..\SEA3DSDK.js'], factory) :
(global = global || self, factory(global.THREE = global.THREE || {}, global.THREE, global.THREE));
}(this, function (exports, THREE, SEA3DSDK_js) { 'use strict';
...
SEA3D.MTXBUF = new THREE.Matrix4();
SEA3D.VECBUF = new THREE.Vector3();
SEA3D.QUABUF = new THREE.Quaternion();
...
SEA3D.prototype = Object.assign( Object.create( THREE.EventDispatcher.prototype ), {
...
SEA3D.Domain.prototype = Object.assign( Object.create( THREE.EventDispatcher.prototype ), {
...
SEA3D.AnimationClip.prototype = Object.assign( Object.create( THREE.AnimationClip.prototype ), {
...
SEA3D.Animation.prototype = Object.assign( Object.create( THREE.EventDispatcher.prototype ), {
...
SEA3D.Object3DAnimator = function ( clips, object3d ) {
	...
	SEA3D.Animator.call( this, clips, new THREE.AnimationMixer( object3d ) );
...
SEA3D.Object3D.prototype = Object.assign( Object.create( THREE.Object3D.prototype ), {
...
SEA3D.Dummy = function ( width, height, depth ) {
	...
	THREE.Mesh.call( this, geo, SEA3D.Dummy.MATERIAL );

};

SEA3D.Dummy.MATERIAL = new THREE.MeshBasicMaterial( { wireframe: true, color: SEA3D.HELPER_COLOR } );

SEA3D.Dummy.prototype = Object.assign( Object.create( THREE.Mesh.prototype ), SEA3D.Object3D.prototype, {
...
SEA3D.Mesh.prototype = Object.assign( Object.create( THREE.Mesh.prototype ), SEA3D.Object3D.prototype, {
...
SEA3D.SkinnedMesh.prototype = Object.assign( Object.create( THREE.SkinnedMesh.prototype ), SEA3D.Mesh.prototype, SEA3D.Animator.prototype, {
...
SEA3D.VertexAnimationMesh.prototype = Object.assign( Object.create( THREE.Mesh.prototype ), SEA3D.Mesh.prototype, SEA3D.Animator.prototype, {
...
SEA3D.Camera.prototype = Object.assign( Object.create( THREE.PerspectiveCamera.prototype ), SEA3D.Object3D.prototype, {
...
SEA3D.OrthographicCamera.prototype = Object.assign( Object.create( THREE.OrthographicCamera.prototype ), SEA3D.Object3D.prototype, {
...
SEA3D.PointLight.prototype = Object.assign( Object.create( THREE.PointLight.prototype ), SEA3D.Object3D.prototype, {
...
SEA3D.PointSound.prototype = Object.assign( Object.create( THREE.PositionalAudio.prototype ), SEA3D.Object3D.prototype, {
...
SEA3D.Sound.prototype = Object.assign( Object.create( THREE.EventDispatcher.prototype ), {
...
SEA3D.prototype.nearestPowerOfTwo = function ( num ) {
	...
	return THREE.Math.pow( 2, THREE.Math.round( THREE.Math.log( num ) / THREE.Math.LN2 ) );
...
SEA3D.prototype.addDefaultAnimation = function ( sea, animatorClass ) {
	...
	for ( var i = 0, count = sea.animations ? sea.animations.length : 0; i < count; i ++ ) {
		...
		switch ( anm.tag.type ) {
			...
			case SEA3DSDK_js.SEA3DSDK.Animation.prototype.type:
...
SEA3D.prototype.readLine = function ( sea ) {
	...
	var line = new THREE.Line( geo, new THREE.LineBasicMaterial( { color: SEA3D.HELPER_COLOR, linewidth: 3 } ) );
	line.name = sea.name;
...
SEA3D.prototype.readMesh = function ( sea ) {
	...
	for ( i = 0, count = sea.modifiers ? sea.modifiers.length : 0; i < count; i ++ ) {
		...
		switch ( mod.type ) {
			...
			case SEA3DSDK_js.SEA3DSDK.Skeleton.prototype.type:
			case SEA3DSDK_js.SEA3DSDK.SkeletonLocal.prototype.type:
			...
			case SEA3DSDK_js.SEA3DSDK.Morph.prototype.type:
	...
	for ( i = 0, count = sea.animations ? sea.animations.length : 0; i < count; i ++ ) {
		...
		switch ( anmTag.type ) {
			...
			case SEA3DSDK_js.SEA3DSDK.SkeletonAnimation.prototype.type:
			...
			case SEA3DSDK_js.SEA3DSDK.VertexAnimation.prototype.type:
			...
			case SEA3DSDK_js.SEA3DSDK.UVWAnimation.prototype.type:
			...
			case SEA3DSDK_js.SEA3DSDK.MorphAnimation.prototype.type:
	...
	if ( uvwAnimationClips ) {
		...
		mesh.uvwAnimator = new SEA3D.Animator( uvwAnimationClips, new THREE.AnimationMixer( mat.map ) );
	...
	if ( morphAnimation ) {
		...
		mesh.morphAnimator = new SEA3D.Animator( morphAnimation, new THREE.AnimationMixer( mesh ) );
...
SEA3D.prototype.readCubeRender = function ( sea ) {
	...
	var cube = new THREE.CubeCamera( 0.1, 5000, SEA3D.RTT_SIZE );
...
SEA3D.prototype.readCubeMapURL = function ( sea ) {
	...
	if ( format === "hdr" ) {
		...
		texture = new HDRCubeTextureLoader().load( THREE.UnsignedByteType, faces, function ( texture ) {
...
SEA3D.prototype.getJSMList = function ( target, scripts ) {
	...
	for ( var i = 0; i < scripts.length; i ++ ) {
		...
		if ( script.tag.type === SEA3DSDK_js.SEA3DSDK.JavaScriptMethod.prototype.type ) {
...
( function () {
	...
	// PHYSICAL
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.PHYSICAL ] =
	function ( mat, tech ) {
	...
	// REFLECTIVITY
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.REFLECTIVITY ] =
	function ( mat, tech ) {
	...
	// CLEAR_COAT
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.CLEAR_COAT ] =
	function ( mat, tech ) {
	...
	// PHONG
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.PHONG ] =
	function ( mat, tech ) {
	...
	// DIFFUSE_MAP
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.DIFFUSE_MAP ] =
	...
	// ROUGHNESS_MAP
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.ROUGHNESS_MAP ] =
	function ( mat, tech ) {
	...
	// METALNESS_MAP
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.METALNESS_MAP ] =
	function ( mat, tech ) {
	...
	// SPECULAR_MAP
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.SPECULAR_MAP ] =
	function ( mat, tech ) {
	...
	// NORMAL_MAP
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.NORMAL_MAP ] =
	function ( mat, tech ) {
	...
	// REFLECTION
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.REFLECTION ] =
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.FRESNEL_REFLECTION ] =
	function ( mat, tech ) {
	...
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.REFLECTION_SPHERICAL ] =
	function ( mat, tech ) {
	...
	// REFRACTION
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.REFRACTION_MAP ] =
	function ( mat, tech ) {
	...
	// LIGHT_MAP
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.LIGHT_MAP ] =
	function ( mat, tech ) {
	...
	// EMISSIVE
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.EMISSIVE ] =
	function ( mat, tech ) {
	...
	// EMISSIVE_MAP
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.EMISSIVE_MAP ] =
	function ( mat, tech ) {
	...
	// ALPHA_MAP
	techniques[ SEA3DSDK_js.SEA3DSDK.Material.ALPHA_MAP ] =
	function ( mat, tech, sea ) {
...
SEA3D.prototype.createMaterial = function ( sea ) {
	...
	if ( sea.tecniquesDict[ SEA3DSDK_js.SEA3DSDK.Material.REFLECTIVITY ] || sea.tecniquesDict[ SEA3DSDK_js.SEA3DSDK.Material.CLEAR_COAT ] ) {

		return new THREE.MeshPhysicalMaterial();

	} else if ( sea.tecniquesDict[ SEA3DSDK_js.SEA3DSDK.Material.PHYSICAL ] ) {
	...
	for ( var i = 0; i < sea.sequence.length; i ++ ) {
		...
		for ( var j = 0; j < sea.dataList.length; j ++ ) {
			...
			switch ( anm.kind ) {
				...
				case SEA3DSDK_js.SEA3DSDK.Animation.POSITION:

					name = '.position';

					break;

				case SEA3DSDK_js.SEA3DSDK.Animation.ROTATION:

					name = '.quaternion';

					break;

				case SEA3DSDK_js.SEA3DSDK.Animation.SCALE:

					name = '.scale';

					break;

				case SEA3DSDK_js.SEA3DSDK.Animation.COLOR:

					name = '.color';

					break;

				case SEA3DSDK_js.SEA3DSDK.Animation.MULTIPLIER:

					name = '.intensity';

					break;

				case SEA3DSDK_js.SEA3DSDK.Animation.FOV:

					name = '.fov';

					break;

				case SEA3DSDK_js.SEA3DSDK.Animation.OFFSET_U:

					name = '.offset[x]';

					break;

				case SEA3DSDK_js.SEA3DSDK.Animation.OFFSET_V:

					name = '.offset[y]';

					break;

				case SEA3DSDK_js.SEA3DSDK.Animation.SCALE_U:

					name = '.repeat[x]';

					break;

				case SEA3DSDK_js.SEA3DSDK.Animation.SCALE_V:

					name = '.repeat[y]';

					break;

				case SEA3DSDK_js.SEA3DSDK.Animation.RADIAN:

					name = '.rotation';

					break;

				case SEA3DSDK_js.SEA3DSDK.Animation.MORPH:
			...
			switch ( anm.type ) {
				...
				case SEA3DSDK_js.SEA3DSDK.Stream.BYTE:
				case SEA3DSDK_js.SEA3DSDK.Stream.UBYTE:
				case SEA3DSDK_js.SEA3DSDK.Stream.INT:
				case SEA3DSDK_js.SEA3DSDK.Stream.UINT:
				case SEA3DSDK_js.SEA3DSDK.Stream.FLOAT:
				case SEA3DSDK_js.SEA3DSDK.Stream.DOUBLE:
				case SEA3DSDK_js.SEA3DSDK.Stream.DECIMAL:
				...
				case SEA3DSDK_js.SEA3DSDK.Stream.VECTOR3D:
				...
				case SEA3DSDK_js.SEA3DSDK.Stream.VECTOR4D:
				...
				case SEA3DSDK_js.SEA3DSDK.Stream.INT24:
				case SEA3DSDK_js.SEA3DSDK.Stream.UINT24:
...
SEA3D.prototype.readSkeletonAnimation = function ( sea, skl ) {
	...
	for ( var i = 0; i < sea.sequence.length; i ++ ) {
		...
		animations.push( SEA3D.AnimationClip.fromClip( THREE.AnimationClip.parseAnimation( animation, skl.tag ), seq.repeat ) );
...
SEA3D.prototype.readVertexAnimation = function ( sea ) {
	...
	for ( i = 0; i < sea.sequence.length; i ++ ) {
		...
		animations.push( SEA3D.AnimationClip.fromClip( THREE.AnimationClip.CreateFromMorphTargetSequence( seq.name, seqTargets, sea.frameRate, !seq.repeat ), seq.repeat ) );
...
SEA3D.prototype.readActions = function ( sea ) {
	...
	for ( var i = 0; i < sea.actions.length; i ++ ) {
		...
		switch ( act.kind ) {
			...
			case SEA3DSDK_js.SEA3DSDK.Actions.ATTRIBUTES:

				this.attribs = this.domain.attribs = act.attributes.tag;

				break;

			case SEA3DSDK_js.SEA3DSDK.Actions.SCRIPTS:
			...
			case SEA3DSDK_js.SEA3DSDK.Actions.CAMERA:

				this.domain.camera = this.camera = act.camera.tag;

				break;

			case SEA3DSDK_js.SEA3DSDK.Actions.ENVIRONMENT_COLOR:
			...
			case SEA3DSDK_js.SEA3DSDK.Actions.ENVIRONMENT:
...
SEA3D.prototype.updatePropertiesAssets = function ( sea, props ) {
	...
	for ( var name in props ) {
		...
		switch ( props.__type[ name ] ) {
			...
			case SEA3DSDK_js.SEA3DSDK.Stream.ASSET:
			...
			case SEA3DSDK_js.SEA3DSDK.Stream.GROUP:
...
SEA3D.prototype.setTypeRead = function () {
	...
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Geometry.prototype.type ] = this.readGeometryBuffer;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Mesh.prototype.type ] = this.readMesh;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Sprite.prototype.type ] = this.readSprite;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Container3D.prototype.type ] = this.readContainer3D;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Line.prototype.type ] = this.readLine;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Material.prototype.type ] = this.readMaterial;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Camera.prototype.type ] = this.readCamera;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.OrthographicCamera.prototype.type ] = this.readOrthographicCamera;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.SkeletonLocal.prototype.type ] = this.readSkeletonLocal;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.SkeletonAnimation.prototype.type ] = this.readSkeletonAnimation;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.JointObject.prototype.type ] = this.readJointObject;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.CubeMap.prototype.type ] = this.readCubeMap;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.CubeRender.prototype.type ] = this.readCubeRender;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Animation.prototype.type ] =
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.MorphAnimation.prototype.type ] =
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.UVWAnimation.prototype.type ] = this.readAnimation;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.SoundPoint.prototype.type ] = this.readSoundPoint;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.TextureURL.prototype.type ] = this.readTextureURL;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.CubeMapURL.prototype.type ] = this.readCubeMapURL;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.AssetUpdate.prototype.type ] = this.readAssetUpdate;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Morph.prototype.type ] = this.readMorph;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.VertexAnimation.prototype.type ] = this.readVertexAnimation;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Actions.prototype.type ] = this.readActions;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.FileInfo.prototype.type ] = this.readFileInfo;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Properties.prototype.type ] = this.readProperties;

	if ( this.config.dummys ) {

		this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Dummy.prototype.type ] = this.readDummy;

	}

	if ( this.config.scripts ) {

		this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.ScriptURL.prototype.type ] = this.readScriptURL;
		this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.JavaScriptMethod.prototype.type ] = this.readJavaScriptMethod;

	}

	if ( this.config.lights ) {

		this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.PointLight.prototype.type ] = this.readPointLight;
		this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.DirectionalLight.prototype.type ] = this.readDirectionalLight;
		this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.HemisphereLight.prototype.type ] = this.readHemisphereLight;
		this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.AmbientLight.prototype.type ] = this.readAmbientLight;

	}

	// UNIVERSAL

	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.JPEG.prototype.type ] =
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.JPEG_XR.prototype.type ] =
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.PNG.prototype.type ] =
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.GIF.prototype.type ] = this.readTexture;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.MP3.prototype.type ] = this.readSound;
	this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.GLSL.prototype.type ] = this.readGLSL;
...
SEA3D.prototype.load = function ( data ) {
	...
	this.file = new SEA3DSDK_js.SEA3DSDK.File();
