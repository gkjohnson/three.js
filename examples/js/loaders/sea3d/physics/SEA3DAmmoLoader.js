/**
 * Generated from 'examples/jsm/loaders/sea3d/physics/SEA3DAmmoLoader.js'
 */

(function (global, factory) {
typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('..\..\SEA3DSDK.js'), require('..\..\SEA3DLoader.js')) :
typeof define === 'function' && define.amd ? define(['exports', 'three', '..\..\SEA3DSDK.js', '..\..\SEA3DLoader.js'], factory) :
(global = global || self, factory(global.THREE = global.THREE || {}, global.THREE, global.THREE, global.THREE));
}(this, function (exports, THREE, SEA3DSDK_js, SEA3DLoader_js) { 'use strict';
...
var AMMO = {
	...
	getTransformFromMatrix: function ( mtx ) {
		...
		var pos = SEA3DLoader_js.SEA3D.VECBUF.setFromMatrixPosition( mtx );
		transform.setOrigin( new Ammo.btVector3( pos.x, pos.y, pos.z ) );

		var scl = SEA3DLoader_js.SEA3D.VECBUF.setFromMatrixScale( mtx );
...
SEA3DLoader_js.SEA3D.prototype.toAmmoVec3 = function ( v ) {
...
SEA3DLoader_js.SEA3D.prototype.readSphere = function ( sea ) {
...
SEA3DLoader_js.SEA3D.prototype.readBox = function ( sea ) {
...
SEA3DLoader_js.SEA3D.prototype.readCone = function ( sea ) {
...
SEA3DLoader_js.SEA3D.prototype.readCylinder = function ( sea ) {
...
SEA3DLoader_js.SEA3D.prototype.readCapsule = function ( sea ) {
...
SEA3DLoader_js.SEA3D.prototype.readConvexGeometry = function ( sea ) {
...
SEA3DLoader_js.SEA3D.prototype.readTriangleGeometry = function ( sea ) {
...
SEA3DLoader_js.SEA3D.prototype.readCompound = function ( sea ) {
	...
	for ( var i = 0; i < sea.compounds.length; i ++ ) {
		...
		SEA3DLoader_js.SEA3D.MTXBUF.elements = compound.transform;

		var transform = AMMO.getTransformFromMatrix( SEA3DLoader_js.SEA3D.MTXBUF );
...
SEA3DLoader_js.SEA3D.prototype.readRigidBodyBase = function ( sea ) {
	...
	if ( sea.target ) {
		...
		SEA3DLoader_js.SEA3D.MTXBUF.fromArray( sea.transform );

		transform = AMMO.getTransformFromMatrix( SEA3DLoader_js.SEA3D.MTXBUF );
...
SEA3DLoader_js.SEA3D.prototype.readRigidBody = function ( sea ) {
...
SEA3DLoader_js.SEA3D.prototype.readCarController = function ( sea ) {
...
SEA3DLoader_js.SEA3D.prototype.readP2PConstraint = function ( sea ) {
...
SEA3DLoader_js.SEA3D.prototype.readHingeConstraint = function ( sea ) {
...
SEA3DLoader_js.SEA3D.prototype.readConeTwistConstraint = function ( sea ) {
...
SEA3DLoader_js.SEA3D.Domain.prototype.enabledPhysics = function ( enabled ) {
...
SEA3DLoader_js.SEA3D.Domain.prototype.applyContainerTransform = function () {
...
SEA3DLoader_js.SEA3D.Domain.prototype.applyTransform = function ( matrix ) {

	var mtx = SEA3DLoader_js.SEA3D.MTXBUF, vec = SEA3DLoader_js.SEA3D.VECBUF;
...
SEA3DLoader_js.SEA3D.Domain.prototype.getShape = SEA3DLoader_js.SEA3D.prototype.getShape = function ( name ) {

	return this.objects[ "shpe/" + name ];

};

SEA3DLoader_js.SEA3D.Domain.prototype.getRigidBody = SEA3DLoader_js.SEA3D.prototype.getRigidBody = function ( name ) {

	return this.objects[ "rb/" + name ];

};

SEA3DLoader_js.SEA3D.Domain.prototype.getConstraint = SEA3DLoader_js.SEA3D.prototype.getConstraint = function ( name ) {

	return this.objects[ "ctnt/" + name ];

};

SEA3DLoader_js.SEA3D.EXTENSIONS_LOADER.push( {
	...
	setTypeRead: function () {
		...
		if ( this.config.physics ) {
			...
			this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Sphere.prototype.type ] = this.readSphere;
			this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Box.prototype.type ] = this.readBox;
			this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Capsule.prototype.type ] = this.readCapsule;
			this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Cone.prototype.type ] = this.readCone;
			this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Cylinder.prototype.type ] = this.readCylinder;
			this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.ConvexGeometry.prototype.type ] = this.readConvexGeometry;
			this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.TriangleGeometry.prototype.type ] = this.readTriangleGeometry;
			this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.Compound.prototype.type ] = this.readCompound;

			// CONSTRAINTS

			this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.P2PConstraint.prototype.type ] = this.readP2PConstraint;
			this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.HingeConstraint.prototype.type ] = this.readHingeConstraint;
			this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.ConeTwistConstraint.prototype.type ] = this.readConeTwistConstraint;

			// PHYSICS

			this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.RigidBody.prototype.type ] = this.readRigidBody;
			this.file.typeRead[ SEA3DSDK_js.SEA3DSDK.CarController.prototype.type ] = this.readCarController;
...
SEA3DLoader_js.SEA3D.EXTENSIONS_DOMAIN.push( {
