/**
 * Generated from 'examples/jsm/loaders/MMDLoader.js'
 */

(function (global, factory) {
typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('..\TGALoader.js'), require('..\..\libs\mmdparser.module.js')) :
typeof define === 'function' && define.amd ? define(['exports', 'three', '..\TGALoader.js', '..\..\libs\mmdparser.module.js'], factory) :
(global = global || self, factory(global.THREE = global.THREE || {}, global.THREE, global.THREE, global.window));
}(this, function (exports, THREE, TGALoader_js, mmdparser_module_js) { 'use strict';
	...
	MMDLoader.prototype = {
		...
		_getParser: function () {
			...
			if ( this.parser === null ) {
				...
				if ( typeof mmdparser_module_js.MMDParser === 'undefined' ) {

					throw new Error( 'THREE.MMDLoader: Import MMDParser https://github.com/takahirox/mmd-parser' );

				}

				this.parser = new mmdparser_module_js.MMDParser.Parser();
