/**
 * Generated from 'examples/jsm/loaders/VRMLLoader.js'
 */

(function (global, factory) {
typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('..\..\libs\chevrotain.module.min.js')) :
typeof define === 'function' && define.amd ? define(['exports', 'three', '..\..\libs\chevrotain.module.min.js'], factory) :
(global = global || self, factory(global.THREE = global.THREE || {}, global.THREE, global.window));
}(this, function (exports, THREE, chevrotain_module_min_js) { 'use strict';
...
var VRMLLoader = ( function () {
	...
	if ( typeof chevrotain_module_min_js.chevrotain === 'undefined' ) {
	...
	VRMLLoader.prototype = {
		...
		parse: function ( data, path ) {
			...
			function createTokens() {
				...
				var createToken = chevrotain_module_min_js.chevrotain.createToken;
				...
				var Comment = createToken( {
					name: 'Comment',
					pattern: /#.*/,
					group: chevrotain_module_min_js.chevrotain.Lexer.SKIPPED
				} );
	...
	function VRMLLexer( tokens ) {
		...
		this.lexer = new chevrotain_module_min_js.chevrotain.Lexer( tokens );
	...
	function VRMLParser( tokenVocabulary ) {
		...
		chevrotain_module_min_js.chevrotain.Parser.call( this, tokenVocabulary );
	...
	VRMLParser.prototype = Object.create( chevrotain_module_min_js.chevrotain.Parser.prototype );
